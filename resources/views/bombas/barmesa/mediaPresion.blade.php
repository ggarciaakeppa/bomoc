    ...
    <div class="container-fluid">
        <div>
            ...
            <div>
                <div class="text-center border-top border-bottom border-2 row row-cols-2 row-cols-lg-4 g-2 g-lg-3">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#diesel"><img src="{{ asset('imagenes/bombas/barmesa/medianaPresion/gasolina.jpg') }}"
                                height="25%" class="figure-img img-fluid rounded" alt=""></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#diesel"><img src="{{ asset('imagenes/bombas/barmesa/medianaPresion/electrico.jpg') }}"
                                height="25%" class="figure-img img-fluid rounded" alt=""></a>
                            <figcaption class="figure-caption ">
        ...
        <div id="diesel" class="mb-3">
            ...
            <div class="card">
                {{-- Contenido Tek-Pro --}}
                <div class="card-body">
                    <h5 class="card-title">Honda | Serie CG</h5>
                    {{-- lh-base --}}
                    <div class="row">
                        <div class="col-md-6">
                            <livewire:centri-media-diesel-table />
