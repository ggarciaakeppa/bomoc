                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#lodosa"><img src="{{ asset('imagenes/bombas/barmesa/lodosa/KMUD.jpg') }}"
                                    height="25%" class="figure-img img-fluid rounded" alt="Serie KMUD"></a>
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#desague"><img src="{{ asset('imagenes/bombas/barmesa/desague/KTM.jpg') }}"
                                    height="25%" class="figure-img img-fluid rounded" alt="Serie KTM"></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#drenaje"><img src="{{ asset('imagenes/bombas/barmesa/drenaje/KAG.jpg') }}"
                                    height="25%" class="figure-img img-fluid rounded" alt="Serie KAG"></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#efluentes"><img
                                    ...
                                    class="figure-img img-fluid rounded" alt="Efluentes"></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#lodos"><img src="{{ asset('imagenes/bombas/barmesa/lodos/lodos.jpg') }}"
                                    height="25%" class="figure-img img-fluid rounded" alt="Lodos"></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#cortadoras"><img
                                    ...
                                    height="25%" class="figure-img img-fluid rounded" alt="Cortadoras"></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#trituradoras"><img
                                    ...
                                    height="25%" class="figure-img img-fluid rounded" alt="Trituradoras"></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#negras"><img
                                    ...
                                    height="25%" class="figure-img img-fluid rounded" alt="AguasNegras"></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="col">
                        <figure class="figure">
                            <a href="#inox"><img
                                    ...
                                    height="25%" class="figure-img img-fluid rounded" alt="Acero inox."></a>
                            <figcaption class="figure-caption ">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/lodosa/lodosaGeneral.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="KMUD">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/desague/desagueGeneral.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="Serie KTM">
                                <div class="row justify-content-center">
                                    <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/drenaje/drenajeGeneral.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="Serie KAG">
                                <div class="row justify-content-center">
                                    <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/efluentes/efluentesGeneral.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="Serie SVEN.1">
                            <img src="{{ asset('imagenes/bombas/barmesa/efluentes/efluentesGeneral2.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="Serie SVEN.2">
                                <div class="row justify-content-center">
                                    <div class="col">
                                    <h5>Modelo: SVEN</h5>
                                    <img src="/imagenes/icons/pdf.svg" style="width: 24px; height: 24px;" alt="pdf"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/lodos/lodosGeneral.jpg') }}"
                                style="vertical-align: middle;" class="figure-img img-fluid rounded" alt="Serie Lodos.1">
                            <img src="{{ asset('imagenes/bombas/barmesa/lodos/lodosGeneral2.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="Serie Lodos.2">
                        </div>
                        <div class="col-md-12">
                            <div class="row justify-content-center">
                            <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/cortadoras/cortadorasGeneral.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="CUT.1">
                            <img src="{{ asset('imagenes/bombas/barmesa/cortadoras/logo.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="CUT.2">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/trituradoras/trituradorasGeneral.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="GRX">
                            <img src="{{ asset('imagenes/bombas/barmesa/trituradoras/trituradorasGeneral2.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="SGV">
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral.jpg') }}"
                                style="horizontal-align: middle" class="figure-img img-fluid rounded" alt="KAT.1">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral2.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="KAT.2">
                                <div class=" row  justify-content-center">
                                    <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral3.jpg') }}"
                                style="horizontal-align: middle" class="figure-img img-fluid rounded" alt="KATO.1">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral4.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="KATO.2">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral5.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="KATO.3">
                                <div class="row justify-content-center">
                                    <div class="col">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral6.jpg') }}"
                                style="horizontal-align: middle" class="figure-img img-fluid rounded" alt="SW.1">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral7.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="SW.2">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral8.jpg') }}"
                                style="vertical-align: middle" class="figure-img img-fluid rounded" alt="SW.3">
                                <div class="row d-flex justify-content-center">
                                    <div class="col">
                                        <h5>Serie: 4SWL-DS</h5>
                                        <img src="/imagenes/icons/pdf.svg" style="width: 24px; height: 24px;" alt="pdf"> 
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            <img src="{{ asset('imagenes/bombas/barmesa/negras/negrasGeneral9.jpg') }}"
                                style="horizontal-align: middle" class="figure-img img-fluid rounded" alt="BSV-DS"> 
                                <div class=" row  justify-content-center">
                                    <div class="col">
