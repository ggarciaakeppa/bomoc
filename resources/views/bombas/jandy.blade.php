   ...
   <div class="container-fluid">
        ...
        <div>
            ...
            <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                <div class="col-md-6 mt-3">
                    <figure class="figure d-flex justify-content-center"><img src="{{ asset('imagenes/bombas/jandy/Victoria Plus Silent VS.jpg') }}"
                            width="80%" class="figure-img img-fluid rounded" alt="">
                    </figure>
                    {{-- direccion de catalogo --}}
                    <div class="d-flex justify-content-center">
                        <a href="https://drive.google.com/file/d/16d93h83KSLpwLjIQZ4lSKdVmTqxgTOAt/view?usp=sharing"
                            class="btn btn-primary ms-4">Victoria Plus Silent VS</a>
                    </div>
                </div>
                <div class="col-md-6 mt-3">
                ...
                <!-- Video -->
                <div>
                    <iframe width="600" height="400" src="https://www.youtube.com/embed/-V9knnU4QwA?si=m8tK8lSlaBaJYmZZ"
                         frameborder="0"
                        allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share"
                        allowfullscreen></iframe>
                         </div>
                         <p>
                        La <b>bomba de piscina residencial Victoria Plus Silent de Velocidad variable </b> es una bomba
                        como la palabra “Silenciosa”, silenciosa viene con motores de dos potencias, con variación y
                        control automatico de velocidad. Incluye una pantalla tactil para conexión en pared.
                    </p>
        ...
        <div>
            <div class="row">
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                    <div class="col-md-6 mt-3">
                        <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/ProductPage.jpg') }}"
        ...
        <div>
            ...
            <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                <div class="col-md-6 mt-3">
                    <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/Bomba MAXIM.jpg') }}"
        ...
        <div>
            <div class="row">
                ...
                <div class="row m-5">
                    <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                        <div class="col-md-6 mt-3">
                            <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/flopro.jpg') }}"
                                    width="65%" class="figure-img img-fluid rounded" alt="">
                                {{-- direccion de catalogo --}}
                                <div class="d-flex justify-content-center">
        ...
        <div>
            <div class="row">
                ...
                <div class="row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                    <div class="col-md-6 mt-3">
                        <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/FloProTM2.jpg') }}"
        ...
        <div>
            <div class="row">
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                    <div class="col-md-6 mt-3">
                        <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/ePump2.jpg') }}"
        ...
        <div>
            <div class=" m-2 p-2">
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                    <div class="col-md-6 mt-3">
                        <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/TOP Inverter2.jpg') }}"
                                width="65%" class="figure-img img-fluid rounded" alt="">
                        </figure>
                        {{-- direccion de catalogo --}}
                        <div class="d-flex justify-content-center">
        ...
        <div>
            <div class=" m-2 p-2">
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                    <div class="col-md-6 ">
                        <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/VersaTemp2.jpg') }}"
                                width="60%" class="figure-img img-fluid rounded" alt="">
                        </figure>
                        {{-- direccion de catalogo --}}
                        <div class="d-flex justify-content-center">
        ...
        <div>
            <div class="col m-2 mt-3 pb-3">
                ...
                <div class="row row-cols-1 row-cols-lg-2 g-2 g-lg-3">
                    <div class="col-md-6 mt-3">
                        <figure class="figure"><img src="{{ asset('imagenes/bombas/jandy/Kivu.jpg') }}"
