...
<body>
    ...
    @include('navbar')
   <div style="  background: url(../imagenes/bombas/altamira/portada.jpg) center center no-repeat;
...
<div class="container-fluid">
        ...
        <div>
            {{-- Logo --}}
            <div class="text-center row row-cols-1 row-cols-lg-1 g-2 g-lg-3">
                <div class="col">
                    <figure class="figure">
            ...
            <div>
                {{-- Esto es la Fila --}}
                <div class="text-center border-top border-bottom border-2 row row-cols-2 row-cols-md-4 g-2 g-lg-3">
                    {{-- Imagen de Bombas Bibo Serie 2800 Flygt la Nueva generación de bombas de Achique --}}
                    <div class="col">
                        <figure class="figure">
                    ...
                    {{-- Imagen de Bombas Trituradoras Inatascables Flygt M --}}
                    <div class="col">
                        <figure class="figure">
                    ...
                    {{-- Imagen de Bomba de doble Etapa Flygt serie 2400.402 --}}
                    <div class="col">
                        <figure class="figure">
