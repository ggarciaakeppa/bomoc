...
use App\Models\AutocebantesGasolinaHonda;

class AutocebantesGasolinaHondaTable extends DataTableComponent
{
    protected $model = AutocebantesGasolinaHonda::class;
